  ...
  <div>
    <div class="container p-8 flex justify-center mx-auto">
      <div class="flex flex-row mx-auto">
        <button v-if="cur === 0" class="bg-blue-300 text-white rounded-l-md border-r border-gray-100 py-2 px-3" type="button">
        ...
        <button v-else class="bg-blue-500 text-white rounded-l-md border-r border-gray-100 py-2 hover:bg-blue-600 hover:text-white px-3" type="button"
                @click="onPrev">
          <div class="flex flex-row align-middle">
            <svg class="w-5 mr-2" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
              <path clip-rule="evenodd"
        ...
        <button v-if="cur === total2" class="bg-blue-300 text-white rounded-r-md py-2 border-l border-gray-200 px-3" type="button">
          <div class="flex flex-row align-middle">
        ...
        <button v-else class="bg-blue-500 text-white rounded-r-md py-2 border-l border-gray-200 hover:bg-blue-600 hover:text-white px-3" @click="onNex"
                type="button">
          <div class="flex flex-row align-middle">
            <span class="mr-2">Next</span>
            <svg class="w-5 ml-2" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
    ...
    <div class="mb-6 p-8">
      ...
      <input id="default-input" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5"
             type="text">
    </div>
  </div>
</template>
